  ...
  renderRoot state =
    HH.main
      ...
      [ case state.practice of
          Just input -> HH.slot practiceSlot unit practiceComponent input RootPracticeOutput
...
practiceComponent :: forall query m. MonadAff m => H.Component query PracticeInput PracticeOutput m
practiceComponent =
  H.mkComponent
