...
data RootAction
  ...
  | RootResetDefaults
  | RootBeginPractice
  | RootPracticeOutput Practice.Output
...
component =
  ...
  renderRoot state =
    HH.main
      ...
      [ case state.practice of
          Just input -> HH.slot practiceSlot unit Practice.component input RootPracticeOutput
  ...
  handleRootAction = case _ of
    ...
    RootPracticeOutput Practice.BackToSetup -> H.modify_ _ { practice = Nothing }
